...
//Funkcja do sprawdzania ilo�ci zabitych wrog�w w scenie
...
//funkcja sprawdzaj�ca ilo�� pokonanych postaci w walce na pie�ci
...
//funkcja sprawdzaj�ca czy dana posta� �yje, funkcja sptrawdza to tylko raz i wypuszcza sygna�
...
//funkcja w��czaj�ca i wy��czaj�ca eksploracj�
...
//Funkcja w kt�rej posta� mo�e nosi� drug� posta� do okre�lonego punktu
...
//Funkcja ka��ca postaci i�� do punktu, funkcja oczekuje na to a� NPc dojdzie do punktu
...
//PW: F-kcja ka��ca postaci i�� do punktu, funkcja nie oczekuje na to a� NPc dojdzie do punktu
...
// Funkcja dodaj�ca wpis do bazy fakt�w
...
//Funckja sprawdzaj�ca wpis w bazie fakt�w
...
//PW: f-kcja obs�uguj�ca scen� pogoni za celem
...
//funkcja w��czajaca i wy��czaj�ca medytacj� 
...
//PW: f-kcja do zbierania aktor�w i ustawiania ich na leadera z POIT. Nie wa�ne, nie patrz na to.
...
//Funkcja kt�ra pozwala na zabranie lub oddanie itemu NPC-owi
...
//funkcja pozwalaj�ca na ustawianie stanu bodypart�w
...
//funkcja pozwalaja�a na dodanie itemu do containera
...
//PW: f-kcja do wrzucania lub zrzucania ze stosu behavior graf�w na postaci
...
//PW: f-kcja do tworzenia entity dynamicznie - mo�na podawa� pozycj� z palca lub wzgl�dem node'a
...
//PW: f-kcja do ustawiania Idle'a na postaci w zasi�gu actorSearchRange
...
// pozwala zrobi� test, czy layer na kt�rym jest obiekt nie zosta� od�adowany - najcz�stsza przyczyna nie dzia�ania destroya
...
//Funkcja w kt�rej gracz mo�e nosi� posta�
...
//Funkcja pozwalaj�ca na raisowanie event�w behaviorowych w scenie
...
//Funkcja uruchamiaj�ca chodzenie po �cie�ce
...
//Funkcja uruchamiaj�ca chodzenie po �cie�ce, trzyma sygnal do momentu gdy postac dojdzie
...
// Funkcja zak�adaj�ca fomracj� w scenie
